...
var Cancel = function (oButton) {
    ...
    var tab = document.getElementById('personsTable');
...
var Update = function (oButton) {
    ...
    for (var i = 1; i < 6; i++) {
        ...
        if (i == 5) {
            var td = tab.getElementsByTagName("td")[i];
            var ele_1 = void 0;
            ele_1 = document.createElement('input'); // TEXTBOX.
            ele_1.setAttribute('type', 'date');
            ele_1.setAttribute('value', td.innerText);
            td.innerText = '';
            td.appendChild(ele_1);
            td.setAttribute('id', '1235');
        }
        if (i == 4) {
            var td = tab.getElementsByTagName("td")[i];
            var ele_2 = void 0;
            ele_2 = document.createElement('input'); // TEXTBOX.
            ele_2.setAttribute('type', 'email');
            ele_2.setAttribute('pattern', "[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$");
            ele_2.setAttribute('value', td.innerText);
            td.innerText = '';
            td.appendChild(ele_2);
            td.setAttribute('id', '1234');
        }
        if (i == 1) {
            var td = tab.getElementsByTagName("td")[i];
            var ele_3 = void 0;
            ele_3 = document.createElement('input'); // TEXTBOX.
            ele_3.setAttribute('type', 'text');
            ele_3.setAttribute('value', td.innerText);
            td.innerText = '';
            td.appendChild(ele_3);
            td.setAttribute('id', '1231');
        }
        if (i == 2) {
            var td = tab.getElementsByTagName("td")[i];
            var ele_4 = void 0;
            ele_4 = document.createElement('input'); // TEXTBOX.
            ele_4.setAttribute('type', 'text');
            ele_4.setAttribute('value', td.innerText);
            td.innerText = '';
            td.appendChild(ele_4);
            td.setAttribute('id', '1232');
        }
        if (i == 6) {
            var td = tab.getElementsByTagName("td")[i];
            var ele_5 = void 0;
            ele_5 = document.createElement('input'); // TEXTBOX.
            ele_5.setAttribute('type', 'text');
            ele_5.setAttribute('value', td.innerText);
            td.innerText = '';
            td.appendChild(ele_5);
